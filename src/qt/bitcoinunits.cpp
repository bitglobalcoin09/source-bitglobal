...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BITG");
    case mBTC: return QString("mBITG");
    case uBTC: return QString::fromUtf8("μBITG");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("BITGs"));
    case mBTC: return QString(QObject::tr("Milli-BITGs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-BITGs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
