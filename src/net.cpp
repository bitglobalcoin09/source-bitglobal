...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("Bitglobalcoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("Bitglobalcoin-net");
...
static const char *strDNSSeed[][2] = {
    {"165.227.212.53", "165.227.212.53"},
    {"174.138.58.233", "174.138.58.233"}
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("Bitglobalcoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("Bitglobalcoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("Bitglobalcoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("Bitglobalcoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bitglobalcoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("Bitglobalcoin-start");
